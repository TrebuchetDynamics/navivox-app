...
29. **Hermes chat hardening** — improved multiple polish/hardening edges in the
   ...
   stale stream responses, and explicit SSE error events (including non-JSON
   error frames) fail the active assistant turn with bounded/redacted recovery
   copy instead of waiting for stream close;
