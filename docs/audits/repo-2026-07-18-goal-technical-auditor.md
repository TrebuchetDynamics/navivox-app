...
- Latest green commit: `b4d47909943cbfd94ff3de8d1595746de0582df4`
- Audit passes: 1
...
| --- | --- | --- | --- | --- | --- |
| M0-1 | High | pending | Restore failing baseline: flutter test --coverage --concurrency=1 | Baseline command exited 1 | — |
