...
void main() {
  test('Android live microphone runbook preserves manual receipt boundary', () {
    ...
    expectRunbookContainsAll(text, [
      ...
      'provider reply excerpt to differ from both\n   spoken phrases',
      'receipt `head_sha` to match the current git\n   `HEAD`',
      'non-empty manufacturer/model/SDK/fingerprint device',
      'expected Navivox package to be installed with version',
